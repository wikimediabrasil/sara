...
urlpatterns = [
    ...
    path(
        "area_activities/<su:code>/",
        views.show_list_of_reports_of_specific_area,
        name="specific_area_activities",
    ),
    path(
        "area_activities/", views.show_list_of_reports_of_area, name="area_activities"
    ),
    re_path(
        r"^(?P<year>20\d{2})/(?P<month>(0?[1-9]|1[012]))$",
        views.show_specific_calendar,
        name="show_specific_calendar",
    ),
    re_path(
        r"^(?P<year>20\d{2})$",
        views.show_specific_calendar_year,
        name="show_specific_calendar_year",
    ),
    re_path(
        r"^(?P<year>20\d{2})/(?P<month>(0?[1-9]|1[012]))/(?P<day>(3[01]|[12][0-9]|0?[1-9]))$",
        views.show_specific_calendar_day,
        name="show_specific_calendar_day",
    ),
]
